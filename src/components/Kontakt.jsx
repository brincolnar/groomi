      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-1 gap-16 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            ...
            <p className="mt-6 max-w-md text-md leading-6 text-white/80">
            ...
            <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-3">
              ...
              <div className="space-y-10">
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded bg-[#ebe1cc] p-1.5">
                    <i className="fa-solid fa-location-dot text-neutral-700 text-xl" aria-hidden="true"></i>
                  </div>
                  <div className="text-md">Breznikova cesta<br />15, Domžale</div>
                </div>

                <div className="flex items-center gap-5">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-md bg-[#ebe1cc] p-2">
                    <i className="fa-solid fa-phone text-neutral-700 text-xl" aria-hidden="true"></i>
                  </div>
                ...
                <div className="flex items-start gap-5">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-md bg-[#ebe1cc] p-2">
                    <i className="fa-regular fa-clock text-neutral-700 text-xl" aria-hidden="true"></i>
                  </div>
              <div className="text-md leading-5 text-white/80">
